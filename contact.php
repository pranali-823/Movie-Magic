...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <!-- Embedded Google Map -->
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15083.153404557188!2d72.899697!3d19.073041!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xb2fd3bcfeac0052a!2sK.J.+Somaiya+College+Of+Engineering!5e0!3m2!1sen!2sin!4v1475256309240" width="100%" height="400" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
            <!-- Contact Details Column -->
            <div class="col-md-4">
                <h3>Contact Details</h3>
                <p>
                    B-205, KJSCE<br>Vidyavihar, Mumbai-77<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: (022) 6987-4568</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:contactus@moviemagic.com" class="text-danger">contactus@moviemagic.com</a>
                </p>
                ...
                <ul class="list-unstyled list-inline list-social-icons">
                    ...
                    <li>
                        <a class="text-danger" href="http://www.linkedin.com"><i class="fa fa-linkedin-square fa-2x"></i></a>
                    </li>
                    <li>
