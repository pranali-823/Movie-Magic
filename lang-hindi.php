...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-7">
                <a href="portfolio-item.php?MovieName=Anna">
                    
                    <img class="img-responsive img-hover" src="bin/display_poster.php?MovieName=Anna" alt="HTML5 Icon" style="width:450x;height:415px">
                </a>
            </div>
            <div class="col-md-5">
                <h3>Anna</h3>
                ...
                <a class="btn btn-danger" href="portfolio-item.php?MovieName=Anna">View Timings</a>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <div class="col-md-7">
                <a href="portfolio-item.php?MovieName=Tutak Tutak Tutiya">
                <img class="img-responsive img-hover" src="bin/display_poster.php?MovieName=Tutak Tutak Tutiya" alt="HTML5 Icon" style="width:450x;height:415px">
                    
                </a>
            </div>
            <div class="col-md-5">
                <h3>Tutak Tutak Tutiya</h3>
                <h4><i class="fa fa-star"></i> 5/5</h4>
                <p>
				 <?php 
                    $MovieName = 'Tutak Tutak Tutiya';
                    include 'bin\displayInfo.php'
                    ?>
				</p>
