...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-7">
                <a href="portfolio-item.php">
                    <img class="img-responsive img-hover" src="bin/display_poster.php?MovieName=Inferno" alt="HTML5 Icon" style="width:450x;height:415px">
                </a>
            </div>
            <div class="col-md-5">
                <h3>Inferno</h3>
                ...
                <a class="btn btn-danger" href="portfolio-item.php?MovieName=Inferno">View Timings</a>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <div class="col-md-7">
                <a href="portfolio-item.php">
                    <img class="img-responsive img-hover" src="bin/display_poster.php?MovieName=Miss Peregrine Home" alt="">
                </a>
            </div>
            <div class="col-md-5">
                <h3>Miss Peregrine's Home</h3>
                <h4><i class="fa fa-star"></i> 5/5</h4>
                <p>
                <?php 
                    $MovieName = "Miss Peregrine Home";
                    include 'bin\displayInfo.php'
                    ?>
                </p>
                <a class="btn btn-danger" href="portfolio-item.php?MovieName=Miss Peregrine Home">View Timings</a>
            </div>
        </div>
        <!-- /.row -->
